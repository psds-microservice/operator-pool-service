...
APP_NAME = operator-pool-service
CMD_PATH = ./cmd/operator-pool-service
BIN_DIR = bin
PORT = 8094
PROTOC_IMAGE = local/protoc-go:latest
PROTO_ROOT = pkg/operator_pool_service
PROTO_FILE = operator_pool.proto
GEN_DIR = pkg/gen/operator_pool_service
GO_MODULE = github.com/psds-microservice/operator-pool-service
OPENAPI_OUT = api
.DEFAULT_GOAL := help

help:
	@echo "operator-pool-service"
