...
func NewAPI(cfg *config.Config) (*API, error) {
	...
	operator_pool_service.RegisterOperatorPoolServiceServer(grpcSrv, grpcImpl)
	reflection.Register(grpcSrv)

	gatewayMux := runtime.NewServeMux()
	if err := operator_pool_service.RegisterOperatorPoolServiceHandlerServer(context.Background(), gatewayMux, grpcImpl); err != nil {
...
func (a *API) Run(ctx context.Context) error {
	...
	log.Printf("  Operator:      %s/operator/", base)
